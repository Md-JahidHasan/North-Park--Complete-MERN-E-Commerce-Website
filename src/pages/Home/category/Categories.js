...
const Categories = () => {
    const categories = [
        ...
        { id: 33, name: 'T-Shirts', image:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0Ye9rR9e1Uv2XakyLh-ryUGuvRuvjCtB8tvkTOiUkld-cgKXw2CI7Zm9wJ8s2b6hiKYU&usqp=CAU'},
