...
import blueShirt from '../../assets/images/product-image/blue-shirt.png';
import discount from '../../assets/images/product-image/discount.png';
        ...
        <div className='z-10 '>
            ...
            >
                ...
                <SwiperSlide className='bg-[#F6F6F2] '>
                    <div>
                        <div className='h-[350px] '>
                            <img className='w-full h-full md:m-4 md:w-4/5 rounded-md md:rounded-tr-[90px] md:rounded-b-[120px] ' src="https://img.freepik.com/free-photo/portrait-curly-haired-young-man-with-copy-space_23-2148892101.jpg?size=626&ext=jpg&ga=GA1.2.1111496724.1678781276&semt=ais" alt="" />
                        </div>
                        <div className='absolute top-[-25%] right-0'>
                            <img src={blueShirt} alt="" />
                        </div>
                        <div className='absolute top-[30%] md:top-[25%] flex flex-col items-center lg:items-end md:left-[28%] lg:left-[32%]'>
                            <h1 className='text-4xl text-white font-bold my-6'>More Luxury and Treading</h1>
                            <p className='text-slate-200'>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                            <p className='text-slate-200'> Nisi id nes ciunt optio recusandae  ducimus.</p>
                            <button className='px-6 py-2 font-bold my-6 ml-8 md:mr-8 rounded-br-2xl md:rounded-br-sm md:rounded-tl-2xl rounded-sm bg-[#FCD12A] text-[#002828] shadow-xl hover:shadow-none hover:bg-[#002828] hover:text-[#FCD12A] duration-150 '>Buy Now</button>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide className='bg-[#F6F6F2] '>
                    <div>
                        <div className='h-[350px]'>
                            <img className='w-full h-full md:w-4/5 md:m-6 md:rounded-b-[70px] md:rounded-tl-[70px]' src="https://img.freepik.com/free-photo/fulllength-attractive-korean-guy-black-clothes-showing-thumbsup-holding-shopping-bags-yellow-b_1258-113844.jpg?size=626&ext=jpg&ga=GA1.2.1111496724.1678781276&semt=ais" alt="" />
                        </div>
                        <div className='absolute md:bottom-[-170px] md:right-[-30px]'>
                            <img className='md:w-[500px]' src={discount} alt="" />
                        </div>
                        <div className='absolute top-[27%] flex flex-col items-end md:left-[28%] '>
                            <h1 className='text-4xl text-[#002828] font-bold my-6'>Get Up To 50% Discount</h1>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                            <p> Nisi id nes ciunt optio recusandae quo. Nostrum, ducimus.</p>
                            <button className='px-6 py-2 font-bold my-6 ml-8 md:mr-8 rounded-br-2xl md:rounded-br-sm md:rounded-tl-2xl rounded-sm bg-[#FCD12A] text-[#002828] shadow-xl hover:shadow-none hover:bg-[#002828] hover:text-[#fca42a] duration-150 '>Buy Now</button>
                        </div>
